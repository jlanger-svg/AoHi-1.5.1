...
Version 1.5 accepts a complete VIN or the last 6–8 characters, offers a selector when multiple vehicles match, and automatically recognises a valid VIN even when Stock Tag mode was selected accidentally.
